 ...
 * Extraite de solitaire/index.html pour le labo photo local.
 * Consommateur : /solitaire/ uniquement.
 * Favorites QC avec surfaces « solitaire » sont fusionnées au runtime.
 */

/* Stock Unsplash + Wikimedia Commons (public domain art). */
const BACKGROUNDS = [
  ...
  /* Snowy Branch (Aaron Burden) retiré — macro glace illisible derrière les cartes ;
     hard-ban dans fullscreen-wallpaper-qc.js (pomo + solitaire). */
