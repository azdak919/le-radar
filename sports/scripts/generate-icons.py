#!/usr/bin/env python3
"""Génère les PNG PWA / favicons « Au tableau » depuis l'emoji trophée.

Calqué sur pomo/scripts/generate-icons.py. Seules la source et la couleur de
fond changent : /sports/ vit sur le système de design du site principal, pas
sur l'ataraxia des mini-apps, donc le fond reprend --bg du thème sombre de
style.css — la même valeur que background_color dans manifest.json racine.
"""
...
EMOJI_PNG = ROOT.parent / "assets" / "emoji" / "trophy.png"
# --bg du thème sombre de style.css (= background_color de manifest.json)
BG = (14, 15, 18, 255)
