...
- Pastilles CTA : 2e ligne AM/PM. **Aujourd’hui / À venir** = **cet AM** / **ce PM**. **Hier / Demain** = **AM** / **PM** (pas « ce PM hier »). Pas En direct ni Prochain match. Labo cartes : légende + grilles AM|PM (plus tout en ce PM par défaut).
