...
| — | 2026-07-29 | Rétro-crawl historique contrôlé : `retro-crawl-historical.js` lit seulement des listes publiques paginées, exclut explicitement les corps WordPress et les médias, reprend dans `historical-crawl-state.json`; 0–12 mois indexables après vérification, 12 mois–3 ans consultables en `noindex,follow`, au-delà conservation interne |
